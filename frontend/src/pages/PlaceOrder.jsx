...
const PlaceOrder = () => {
  ...
  const { cartItems, products, getCartTotal, deliveryFee, backendUrl, token, setCartItems } = useContext(ShopContext);
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      {/* -----------left side------------- */}
      <div className='flex flex-col gap-4 w-full sm:max-w-122'>
